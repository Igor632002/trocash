...
export default async function OfferPage({ params }) {
    ...
    return (
        ...
        <div className="offer-page" style={{ display: "flex", justifyContent: "center", width: "100%", padding: "20px" }}>
            <article className="offer-card card" style={{ border: "1px solid #ccc", width: "300px", padding: "20px" }}>      <div
