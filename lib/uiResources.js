    ...
    export const copy = {
      pt: {
        ...
        searchTitle: "O que você procura?",searchSub: "Encontra uma troca que faça sentido para ti",category: "Categoria", have: "Eu tenho", want: "Procuro", distance: "Até", matches: "Encontros para si", trust: "Confiança que se conquista", premium: "troCASH PREMIUM",
      ...
      en: {
        ...
        searchTitle: "What are you looking for?",searchSub: "Find a swap that makes sense for you",category: "Category:", have: "I have", want: "I want", distance: "Within", matches: "Matches for you", trust: "Trust is earned", premium: "troCASH PREMIUM",
      ...
      uk: {
        ...
        searchTitle: "Що ви шукаєте?",searchSub: "Знайди речі, які будуть тобі корисні",category: "Категорія", have: "Пропоную", want: "Шукаю", distance: "У радіусі", matches: "Підібрано для вас", trust: "Довіра заробляється", premium: "troCASH PREMIUM",
